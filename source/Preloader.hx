...
{
	public static var psychEngineJPVersion:String = '0.6.3-3.0.0';
	...
	function openPauseMenu()
	{
		...
		DiscordClient.changePresence(detailsPausedText, SONG.song + " (" + storyDifficultyText + ")", iconP2.getCharacter());
		#end
		Lib.application.window.title = "Friday Night Funkin': Psych Engine-JP v" + psychEngineJPVersion + " - " + SONG.song + " [" + storyDifficultyText + "] - Paused";
	}
