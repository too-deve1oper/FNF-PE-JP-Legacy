...
class EditorPlayState extends MusicBeatState
{
	...
	override function create()
	{
		...
		sectionTxt = new FlxText(10, 580, FlxG.width - 20, "セクション: 0", 20);
		...
		beatTxt = new FlxText(10, sectionTxt.y + 30, FlxG.width - 20, "ビート: 0", 20);
		...
		stepTxt = new FlxText(10, beatTxt.y + 30, FlxG.width - 20, "ステップ: 0", 20);
		...
		var tipText:FlxText = new FlxText(10, FlxG.height - 24, 0, 'Escでチャートエディター | Chart Editorへ戻る', 16);
